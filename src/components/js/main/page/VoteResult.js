        ...
        <>
            <div className={'select-panel'}>
                <div className={'radio-panel'}>
                    <label><input className={'start-date'} name={'start-date'} type={'radio'} defaultChecked={true}/><span>전체</span></label>
                ...
                <hr/>
                <div className={'radio-panel'}>
                    <label><input className={'end-date'} name={'end-date'} type={'radio'} defaultChecked={true}/><span>전체</span></label>
